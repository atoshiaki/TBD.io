  ...
  function createNewRow(video) {
    var $newInputRow = $(
      [
        ...
        "<iframe width='750' height='465' src='https://www.youtube.com/embed/" + video.text + "' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>",
        "<button class='delete btn btn-danger'> Delete </button>",
        "<button class='complete btn btn-primary'> Mark as Watched </button>",
        "</li>"
      ].join("")
    );
